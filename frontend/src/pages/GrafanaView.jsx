  ...
  return (
    <div className="page-container">
      ...
      <div className="alert alert-info">
        <AlertCircle size={18} />
        <div>
          <strong>Tips:</strong> Dashboard ditampilkan via proxy <code style={{ background: 'rgba(0,0,0,0.05)', padding: '2px 6px', borderRadius: 4 }}>/grafana</code> (same-origin),
          jadi tetap jalan walau diakses lewat domain publik. Jika kosong, pastikan service Grafana aktif.
