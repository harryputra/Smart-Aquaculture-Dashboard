...
// Kecepatan spinner per batch ganjil/genap
const uint8_t SPINNER_PWM_MAX = 255; // Kecepatan spinner per batch ganjil
const uint8_t SPINNER_PWM_MIN = 255; // Kecepatan spinner per batch genap
...
bool runSingleBatch(float targetGram, int batchIndex, int batchNo, int totalBatches, float &actualGram) {
  ...
  // ---- SPINNER PRE-START (PWM tetap berdasarkan pasangan batch) ----
  // PWM berganti tiap 2 batch; arah CW/CCW berganti tiap 1 batch.
